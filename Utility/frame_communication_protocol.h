...
#define FCP_HEADER_SIZE       4
/** @brief Maximum size of the payload of an FCP frame */
#define FCP_MAX_PAYLOAD_SIZE  30
...
typedef void (* FCP_ReceivedFrameCallback_t)( struct MCP_Handle_s * o );
 ...
 */
typedef uint8_t (*FCP_SendFct_t)( FCP_Handle_t * pHandle);
